...
Icon.propTypes = {
  ...
  size: require('prop-types').oneOfType([require('prop-types').oneOf(['small']), require('prop-types').oneOf(['medium']), require('prop-types').oneOf(['large']), require('prop-types').string]),
