...
var componentTheme = exports.componentTheme = function componentTheme(baseTheme) {
  return _extends({
    ...
    TextArea_fontSize_small: (0, _styles.pxToEm)(12),
...
var styles = {
  textArea: function textArea(_ref) {
    ...
    return {
      ...
      minWidth: 0,
      outline: 0,
      padding: paddingVerticalNormalized + ' ' + (0, _styles.getNormalizedValue)(theme.TextArea_paddingHorizontal, fontSize),
  ...
  _createClass(TextArea, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        Root,
        rootProps,
        _react2.default.createElement(_TextArea, textAreaProps),
        _ref3
      );
    }
  }]);
