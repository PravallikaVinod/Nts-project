...
var Root = (0, _styles.createStyledComponent)('span', function (_ref) {
  ...
  var color = propColor || (background ? (0, _colors.getReadableTextColor)(background, 60) : theme.color_text_onprimary);
  ...
  return {
    ...
    backgroundColor: function () {
      if (noBackground) {
        ...
        return (0, _colors.getColor)(background, 60) || background;
      } else {
...
function Avatar(_ref2) {
  ...
  _react.Children.map(children, function (child) {
    if (typeof child === 'string') {
      ...
      icon = (0, _react.cloneElement)(child, { size: iconSize[size] });
    } else {
      noBackground = true;
    }
  });
