...
var Root = createStyledComponent(Popper, function (_ref) {
  ...
  _createClass(DropdownContent, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          wide = _props.wide,
          restProps = _objectWithoutProperties(_props, ['data', 'getItemProps', 'id', 'placement', 'wide']);
...
DropdownContent.propTypes = {
  ...
  getItemProps: require('prop-types').func,

  /** Data from which the [Menu](../menu#data) will be constructed */
  data: require('prop-types').arrayOf(require('prop-types').object).isRequired,
