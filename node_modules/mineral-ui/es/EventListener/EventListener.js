...
EventListener.propTypes = {
  listeners: require('prop-types').arrayOf(require('prop-types').shape({
    /** Target on which to add event listener. Can be a global such as `window` or `document` or any CSS selector */
    target: require('prop-types').string.isRequired,

    /** Type of event to listen for, e.g. click */
    event: require('prop-types').string.isRequired,

    /** Function called when the event is triggered */
    handler: require('prop-types').func.isRequired,

    /** Options passed to addEventListener/removeEventListener */
    options: require('prop-types').oneOfType([require('prop-types').bool, require('prop-types').object])
  })).isRequired
};
