...
var styles = {
  content: function content(props) {
    ...
    var paddingBottom = getNormalizedValue(pxToEm(4), fontSize);
    var paddingTop = getNormalizedValue(pxToEm(3), fontSize);
  ...
  secondaryText: function secondaryText(props) {
    ...
    return {
      ...
      paddingTop: getNormalizedValue(pxToEm(3), theme.MenuItemSecondaryText_fontSize),
  ...
  text: function text(props) {
    ...
    var margin = getNormalizedValue(theme.space_inline_sm, theme.MenuItemContent_fontSize);
...
var CustomRoot = withTheme(function (_ref) {
  var item = _ref.item,
...
var customRender = function customRender(_ref3) {
  ...
  return React.createElement(CustomRoot, customRootProps);
};
 ...
 */
export default function MenuItem(_ref4) {
