...
var styles = {
  input: function input(_ref) {
    ...
    var paddingWithoutIcon = getNormalizedValue(theme.TextInput_paddingHorizontal, fontSize);
  ...
  prefix: function prefix(_ref2) {
    ...
    var fontSize = size === 'small' ? theme.TextInput_fontSize_small : theme.TextInput_fontSize;
    var marginWithIcon = getNormalizedValue(theme.TextInput_paddingHorizontal, fontSize);
    var marginWithoutIcon = getNormalizedValue(parseFloat(theme.TextInputIcon_marginHorizontal) / 2 + 'em', fontSize);
...
export default function TextInput(_ref6) {
