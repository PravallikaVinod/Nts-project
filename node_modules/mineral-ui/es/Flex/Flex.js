...
var getGutterSize = function getGutterSize(theme, value) {
  return typeof value === 'number' ? pxToEm(value / 2) : parseFloat(theme['space_inline_' + value] || value) / 2 + 'em';
};
...
var ThemedRoot = withTheme(function (_ref2) {
  ...
  flexItems = Children.map(children, function (child) {
