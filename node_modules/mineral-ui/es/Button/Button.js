...
Button.propTypes = {
  ...
  circular: require('prop-types').bool,

  /** Disables the Button */
  disabled: require('prop-types').bool,

  /** Element to be used as the root node - e.g. `a` can be used to create a link that is styled like a Button */
  element: typeof $FlowFixMe === 'function' ? require('prop-types').instanceOf($FlowFixMe) : require('prop-types').any,
  ...
  minimal: require('prop-types').bool,

  /** Called with the click event */
  onClick: require('prop-types').func,

  /** Display a primary Button */
  primary: require('prop-types').bool,
