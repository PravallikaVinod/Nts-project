...
var CardFooter = function (_Component) {
  ...
  function CardFooter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref4 = CardFooter.__proto__ || Object.getPrototypeOf(CardFooter)).call.apply(_ref4, [this].concat(args))), _this), _this.state = {
      ...
      var _ref5 = _this.isControlled() ? _this.props : _this.state,
          isOpen = _ref5.isOpen;
  ...
  _createClass(CardFooter, [{
    ...
    value: function render() {
      ...
      var _ref6 = this.isControlled() ? this.props : this.state,
          isOpen = _ref6.isOpen;
...
CardFooter.propTypes = {
  ...
  expandable: require('prop-types').bool,
  ...
  /** Title of the footer */
  title: require('prop-types').oneOfType([require('prop-types').string, typeof React$Element === 'function' ? require('prop-types').instanceOf(React$Element) : require('prop-types').any]),

  /** If `expandable`, title for expand/collapse trigger */
  triggerTitle: require('prop-types').func,

  /** Available variants */
  variant: require('prop-types').oneOf(['danger', 'success', 'warning'])
};
