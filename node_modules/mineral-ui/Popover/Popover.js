...
var Popover = function (_Component) {
  ...
  function Popover() {
    ...
    }, _this.id = 'popover-' + (0, _utils.generateId)(), _this.close = function (event) {
  ...
  _createClass(Popover, [{
    ...
    value: function render() {
      ...
      var popoverTriggerProps = {
        ...
        onClick: !disabled ? (0, _utils.composeEventHandlers)(this.toggleOpenState, child.props.onClick) : undefined,
      ...
      return _react2.default.createElement(
        Root,
        rootProps,
        _react2.default.createElement(_PopoverTrigger2.default, popoverTriggerProps),
